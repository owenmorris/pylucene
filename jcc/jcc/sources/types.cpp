...
PyTypeObject TYPE_NAME(FinalizerClass) = {
...
PyTypeObject TYPE_NAME(FinalizerProxy) = {
    PyObject_HEAD_INIT(NULL)
    0,                                   /* ob_size */
...
static PyObject *t_fc_call(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    if (obj)
    {
        t_fp *fp = (t_fp *) TYPE_NAME(FinalizerProxy).tp_alloc(&TYPE_NAME(FinalizerProxy), 0);
...
PyTypeObject TYPE_NAME(ConstVariableDescriptor) = {
    PyObject_HEAD_INIT(NULL)
    0,                                   /* ob_size */
...
PyObject *make_descriptor(PyTypeObject *value)
{
    t_descriptor *self = (t_descriptor *)
        TYPE_NAME(ConstVariableDescriptor).tp_alloc(&TYPE_NAME(ConstVariableDescriptor), 0);
